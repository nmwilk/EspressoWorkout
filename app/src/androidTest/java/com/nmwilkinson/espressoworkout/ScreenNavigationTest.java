...
public class ScreenNavigationTest {
    ...
    @Test
    public void itemSelectionAndBack() {
        // first screen
        ...
        // second screen
        onView(withId(R.id.display_selected_item)).check(matches(isDisplayed()));
        onView(withId(R.id.display_selected_item)).check(matches(withText("Do to the Beast")));
        pressBack();
